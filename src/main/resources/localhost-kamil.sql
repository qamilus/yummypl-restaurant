...
INSERT INTO LOCATIONS_TYPE(ID, NAME)
VALUES (LOCATIONS_TYPE_ID_SEQ.NEXTVAL, 'RESTAURANT');

INSERT INTO LOCATIONS_TYPE(ID, NAME)
VALUES (LOCATIONS_TYPE_ID_SEQ.NEXTVAL, 'ORDER');
...
INSERT INTO LOCATIONS(ID, CITY, STREET, HOUSE_NUMBER, LOCATION_TYPE_ID)
VALUES (LOCATIONS_ID_SEQ.NEXTVAL, 'Warszawa', 'Marszalkowska', '22b', 1);

INSERT INTO LOCATIONS(ID, CITY, STREET, HOUSE_NUMBER, LOCATION_TYPE_ID)
VALUES (LOCATIONS_ID_SEQ.NEXTVAL, 'Warszawa', 'Mokotowska', '23b', 1);

INSERT INTO LOCATIONS(ID, CITY, STREET, HOUSE_NUMBER, LOCATION_TYPE_ID)
VALUES (LOCATIONS_ID_SEQ.NEXTVAL, 'Warszawa', 'Piękna', '21b', 1);

INSERT INTO LOCATIONS(ID, CITY, STREET, HOUSE_NUMBER, LOCATION_TYPE_ID)
VALUES (LOCATIONS_ID_SEQ.NEXTVAL, 'Poznań', 'Sosnkowskiego', '141', 2);

INSERT INTO LOCATIONS(ID, CITY, STREET, HOUSE_NUMBER, LOCATION_TYPE_ID)
VALUES (LOCATIONS_ID_SEQ.NEXTVAL, 'Toruń', 'Piernikowa', '33', 1);

INSERT INTO LOCATIONS(ID, CITY, STREET, HOUSE_NUMBER, LOCATION_TYPE_ID)
VALUES (LOCATIONS_ID_SEQ.NEXTVAL, 'Gdańsk', 'Nadmorska', '4b', 2);

INSERT INTO LOCATIONS(ID, CITY, STREET, HOUSE_NUMBER, LOCATION_TYPE_ID)
VALUES (LOCATIONS_ID_SEQ.NEXTVAL, 'Orzysz', 'Górska', '15b', 1);
...
INSERT INTO RESTAURANTS(ID, NAME, LOCATION_ID)
VALUES (RESTAURANTS_ID_SEQ.NEXTVAL, 'Trattoria Rucola', 1);

INSERT INTO RESTAURANTS(ID, NAME, LOCATION_ID)
VALUES (RESTAURANTS_ID_SEQ.NEXTVAL, 'U Gruzina', 2);

INSERT INTO RESTAURANTS(ID, NAME, LOCATION_ID)
VALUES (RESTAURANTS_ID_SEQ.NEXTVAL, 'Roma', 3);

INSERT INTO RESTAURANTS(ID, NAME, LOCATION_ID)
VALUES (RESTAURANTS_ID_SEQ.NEXTVAL, 'Pizza Hut', 21);

INSERT INTO RESTAURANTS(ID, NAME, LOCATION_ID)
VALUES (RESTAURANTS_ID_SEQ.NEXTVAL, 'Fishlandia', 22);

INSERT INTO RESTAURANTS(ID, NAME, LOCATION_ID)
VALUES (RESTAURANTS_ID_SEQ.NEXTVAL, 'Koziolek', 23);
...
VALUES (RESTAURANTS_INFORMATION_ID_SEQ.nextval, '11-22', 3);

INSERT INTO RESTAURANTS_INFORMATION(ID, OPENING_HOURS, RESTAURANT_ID)
VALUES (RESTAURANTS_INFORMATION_ID_SEQ.nextval, '12-23', 9);
INSERT INTO RESTAURANTS_INFORMATION(ID, OPENING_HOURS, RESTAURANT_ID)
VALUES (RESTAURANTS_INFORMATION_ID_SEQ.nextval, '11-24', 10);

CREATE SEQUENCE ORDERS_ID_SEQ;
INSERT INTO LOCATIONS(ID, CITY, STREET, HOUSE_NUMBER, LOCATION_TYPE_ID)
VALUES (LOCATIONS_ID_SEQ.NEXTVAL, 'Kraków', 'Malopolska', '125b', 2);
INSERT INTO LOCATIONS(ID, CITY, STREET, HOUSE_NUMBER, LOCATION_TYPE_ID)
VALUES (LOCATIONS_ID_SEQ.NEXTVAL, 'Kraków', 'Podwale', '14b', 1);
INSERT INTO RESTAURANTS(ID, NAME, LOCATION_ID)
VALUES (RESTAURANTS_ID_SEQ.NEXTVAL, 'Smocza', 27);
SELECT *
FROM orders_status;
CREATE SEQUENCE ORDERS_STATUS_ID_SEQ;
INSERT INTO ORDERS_STATUS(ID, NAME)
VALUES (ORDERS_STATUS_ID_SEQ.NEXTVAL, 'New');
INSERT INTO ORDERS_STATUS(ID, NAME)
VALUES (ORDERS_STATUS_ID_SEQ.NEXTVAL, 'In progress');
INSERT INTO ORDERS_STATUS(ID, NAME)
VALUES (ORDERS_STATUS_ID_SEQ.NEXTVAL, 'Done');
INSERT INTO ORDERS_STATUS(ID, NAME)
VALUES (ORDERS_STATUS_ID_SEQ.NEXTVAL, 'Canceled');
INSERT INTO ORDERS(id, location_id, order_status_id, restaurant_id)
VALUES (ORDERS_ID_SEQ.NEXTVAL, 27, 1, 24);
...
INSERT INTO ORDERS_ITEMS(ID, NAME, PRICE, QUANTITY, ORDER_ID)
VALUES (ORDERS_ITEMS_ID_SEQ.nextval, 'Rumsztyk Staropolski', 26.99, 1, 1);
INSERT INTO ORDERS_ITEMS(ID, NAME, PRICE, QUANTITY, ORDER_ID)
VALUES (ORDERS_ITEMS_ID_SEQ.nextval, 'Spaghetti', 22.99, 1, 1);
INSERT INTO ORDERS_ITEMS(ID, NAME, PRICE, QUANTITY, ORDER_ID)
VALUES (ORDERS_ITEMS_ID_SEQ.nextval, 'Cola Zero', 6.99, 2, 1);
INSERT INTO ORDERS_ITEMS(ID, NAME, PRICE, QUANTITY, ORDER_ID)
VALUES (ORDERS_ITEMS_ID_SEQ.nextval, 'Risotto Grzybowe', 26.99, 1, 21);
...
VALUES (MENU_ID_SEQ.nextval, 'Karta Dań', 24);
INSERT INTO MENU(ID, NAME, RESTAURANT_ID)
VALUES (MENU_ID_SEQ.nextval, 'Karta Win', 24);
...
INSERT INTO MENU_ITEMS(ID, NAME, PRICE, QUANTITY, MENU_ID)
VALUES (MENU_ITEMS_ID_SEQ.nextval, 'Rumsztyk Staropolski', 26.99, '200g', 1);
INSERT INTO MENU_ITEMS(ID, NAME, PRICE, QUANTITY, MENU_ID)
VALUES (MENU_ITEMS_ID_SEQ.nextval, 'Spaghetti', 22.99, '300g', 1);
INSERT INTO MENU_ITEMS(ID, NAME, PRICE, QUANTITY, MENU_ID)
VALUES (MENU_ITEMS_ID_SEQ.nextval, 'Cola Zero', 6.99, '330ml', 1);
INSERT INTO MENU_ITEMS(ID, NAME, PRICE, QUANTITY, MENU_ID)
VALUES (MENU_ITEMS_ID_SEQ.nextval, 'Sałatka Grecka', 16.99, '300g', 1);
INSERT INTO MENU_ITEMS(ID, NAME, PRICE, QUANTITY, MENU_ID)
VALUES (MENU_ITEMS_ID_SEQ.nextval, 'Pizza Wawelska', 46.99, '700g', 1);
